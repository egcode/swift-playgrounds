...
if let singToTokyokCost = adjacencyList.weight(from: singapore, to: tokyo) {
    print("Singapore to Tokyo cost: \(singToTokyokCost)")
}

if let sanFranFlights = adjacencyList.edges(from: sanFrancisco) {
    print("San Francisco Out Going Flights:")
    print("--------------------------------")
    for edge in sanFranFlights {
